...
/**
 * Register Page
 * Mobile-first con glassmorphism, escritorio split-screen
 */
...
const PASSWORD_REQUIREMENTS = [
  { id: 'min-length', label: 'Al menos 8 caracteres', test: (p: string) => p.length >= 8 },
...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      {/* Background Gradient con Formas Geométricas */}
      ...
      {/* Contenedor - Mobile glassmorphism, Desktop split */}
      <div className="w-full max-w-6xl relative z-10">
        {/* Vista Móvil - Tarjeta Glassmorphism */}
        <div className="md:hidden">
          <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-md rounded-2xl shadow-2xl p-6 mx-4 max-h-[90vh] overflow-y-auto">
            <div className="mb-6">
              ...
              <p className="text-gray-600 dark:text-gray-300">Únete a FinanceTrackerPro</p>
            </div>
            ...
            <div className="relative bg-gradient-to-br from-indigo-400 via-purple-500 to-purple-800 p-12 flex flex-col items-center justify-center text-white overflow-hidden">
              ...
              <div className="relative z-10 text-center max-w-sm">
                <div className="mb-8">
                  ...
                  <h2 className="text-4xl font-black mb-4">¿Ya tienes cuenta?</h2>
                  <p className="text-purple-50 text-lg leading-relaxed">
                    Inicia sesión para acceder a tu panel financiero y gestionar tu dinero de manera
                    inteligente
                  </p>
                </div>
            ...
            <div className="p-12 flex flex-col justify-center bg-white dark:bg-gray-800">
              <div className="mb-6">
                ...
                <p className="text-gray-500 dark:text-gray-400 text-lg">
                  Regístrate para empezar con FinanceTrackerPro
                </p>
              </div>
