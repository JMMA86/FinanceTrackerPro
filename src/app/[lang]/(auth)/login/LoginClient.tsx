...
export default function LoginClient({
  ...
  isRegistered,
  redirectPath,
}: Readonly<LoginClientProps>) {
  const router = useRouter();
  const [loading, setLoading] = useState(false);
  const [error, setError] = useState('');

  const success = isRegistered ? get(auth, 'login.successMessage') : '';
        ...
        <div className="md:hidden">
          <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-md rounded-2xl shadow-2xl p-6 mx-4">
            <div className="mb-6">
              ...
              <p className="text-gray-600 dark:text-gray-300">{get(auth, 'login.subtitle')}</p>
            </div>
            ...
            <div className="relative bg-gradient-to-br from-cyan-400 via-blue-500 to-blue-800 p-12 flex flex-col items-center justify-center text-white overflow-hidden">
              ...
              <div className="relative z-10 text-center max-w-sm">
                <div className="mb-8">
                  ...
                  <h2 className="text-4xl font-black mb-4">{get(auth, 'register.newUserTitle')}</h2>
