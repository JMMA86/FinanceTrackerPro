      ...
      <div className="w-full max-w-6xl relative z-10">
        ...
        <div className="hidden md:block bg-white dark:bg-gray-800 rounded-3xl shadow-2xl shadow-black/50 border border-white/10 overflow-hidden backdrop-blur-sm">
          <div className="relative h-[800px] overflow-hidden">
            ...
            <div className="absolute left-0 top-0 w-1/2 h-full bg-white dark:bg-gray-800 z-10">
              <div className="absolute inset-0 p-12 overflow-y-auto flex flex-col justify-center">
                <div className="mb-8">
                  <div className="inline-flex items-center justify-center w-14 h-14 bg-slate-700 rounded-2xl mb-6">
                    <svg
                ...
                <form onSubmit={handleLoginSubmit} className="space-y-5">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-slate-700 hover:bg-slate-800 text-white font-semibold py-3.5 px-4 rounded-xl transition-all transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed shadow-lg mt-8"
                  >
            ...
            <div className="absolute right-0 top-0 w-1/2 h-full bg-white dark:bg-gray-800 z-10">
              <div className="absolute inset-0 p-12 overflow-y-auto flex flex-col justify-center">
                <div className="mb-6">
                  <div className="inline-flex items-center justify-center w-14 h-14 bg-slate-700 rounded-2xl mb-6">
                    <svg
              ...
              <div className="w-1/2 flex-shrink-0">
                <form onSubmit={handleLoginSubmit} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-slate-700 hover:bg-slate-800 text-white font-semibold py-3 rounded-xl disabled:opacity-50 shadow-lg mt-8"
                  >
                    {loading ? get(auth, 'login.submitting') : get(auth, 'login.submit')}
                  </button>
                </form>
