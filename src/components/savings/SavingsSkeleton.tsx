/**
 * SavingsSkeleton — single reusable loading placeholder for the savings module.
 *
 * Used by `src/app/[lang]/(dashboard)/savings/loading.tsx` for the route-level
 * loading state. Decorative content is `aria-hidden` so screen readers are not
 * flooded with pulsing boxes; an `aria-live` wrapper (role="status") belongs in
